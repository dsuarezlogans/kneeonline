<?php
	...
	*/
	...
	if ( !$has_access ) {
		...
		$woourl = types_render_field("woocommerce_url", array("output"=>"raw"));
		if ($woourl != '')
			echo '<BR><a href="'.$woourl.'" class="enrollbutton"><img src="'.get_bloginfo('template_directory').'/img/12_shopping_car_W_100px.png" width="30" height="30" align="top"> &nbsp;'.__('Enroll').'</a><BR><BR>';
	}
