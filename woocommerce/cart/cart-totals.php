...
<div class="cart_totals <?php if ( WC()->customer->has_calculated_shipping() ) echo 'calculated_shipping'; ?>">
	...
	<?php if ( WC()->cart->get_cart_tax() ) : ?>
		<p class="wc-cart-shipping-notice"><small><?php
			...
			printf( __( 'Una vez efectuado el pago, el alumno/profesional declara conocer y aceptar el funcionamiento del curso y por este motivo no se admitirán devoluciones de ningún tipo', 'woocommerce' ), $estimated_text );
