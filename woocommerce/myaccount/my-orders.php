...
if ( $customer_orders ) : ?>
	...
	<h2><img src="<?php bloginfo('template_directory'); ?>/img/52_pedidos_B_100px.png" align="absbottom" width="48" height="48"> <?php echo apply_filters( 'woocommerce_my_account_my_orders_title', __( 'Recent Orders', 'woocommerce' ) ); ?></h2>
