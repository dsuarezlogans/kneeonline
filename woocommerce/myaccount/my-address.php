...
<h2><img src="<?php bloginfo('template_directory'); ?>/img/21_address_B_100px.png" align="absbottom" width="48" height="48"> <?php echo $page_title; ?></h2>
...
<?php foreach ( $get_addresses as $name => $title ) : ?>
	...
	<div class="col-<?php echo ( ( $col = $col * -1 ) < 0 ) ? 1 : 2; ?> address">
		<header class="title">
			<h3><img src="<?php bloginfo('template_directory'); ?>/img/22_billing_address_B_100px.png" align="absbottom" width="36" height="36"> <?php echo $title; ?></h3>
